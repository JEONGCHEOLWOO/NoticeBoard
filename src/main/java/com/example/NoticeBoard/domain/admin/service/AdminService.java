...
//
//// CQRS 구조로 분리 필요. Redis, kafka 필요?, Admin 전체 수정 필요.
//@Service
...
//                .reporter(postReport.getReporter())
//                .reportee(post.getUserId())
//                .postId(postId)
...
//                .reporter(commentReport.getReporter()) // 신고자
//                .reportee(comment.getUserId()) // 피신고자(고발당한 사람)
//                .commentId(commentId)
...
//                .collect(Collectors.groupingBy(r -> r.getReporter()));
//
//        // 댓글 신고자 Id
