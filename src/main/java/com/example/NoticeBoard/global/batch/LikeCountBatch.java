...
public class LikeCountBatch {
    ...
    // 좋아요 수 증가 Batch - KEYS 대신 SCAN 사용, 5분마다 갱신
    ...
    // SCAN 0 MATCH post:like:count:* COUNT 100
    ...
    public void syncLikeCount(){
        ...
        while (cursor.hasNext()){
            ...
            try{
                ...
                postRepository.increaseLikeCount(postId, count);
                redisTemplate.delete(key);
                log.info("게시글 좋아요 count 동기화 완료 postId={}, count={}", postId, count);
            } catch (Exception e) {
                log.error("PostLike Count batch 처리 실패 key={}", key, e);
            }
        }
